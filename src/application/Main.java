...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		x0.setOnAction(ccv45 -> {
			...
			Label f1 = new Label("Read Passengers:");
			TextField ft1 = new TextField("Warning messages!");
			ft1.setEditable(false);
			
			Label f11 = new Label("Read flight:");
			TextField ft11 = new TextField("Warning messages!");
			...
			Gridpane1.add(b1, 1, 1);
			Gridpane1.add(b2, 1, 0);
			Gridpane1.addRow(3,f1,ft1);
			Gridpane1.addRow(2,f11,ft11);

			

			Scene scene1 = new Scene(Gridpane1, 600, 600);
			...
			intreted1.setOnAction(m -> {
				...
				try {
					textArea2.setText(LN.printPassengers(Integer.parseInt(textField2.getText())));
						...
						textArea2.setText("enter all information!");
					}
		...
		x3.setOnAction(e2 -> {
			...
			b1.setOnAction(esrg -> {
				...
				Label f1 = new Label("Masseg:");
				TextArea ft1 = new TextArea("Warning messages!");
				...
				add1.setOnAction(d022 -> {
					...
					try {
						if (LN.checkFlightNumber(Integer.parseInt(FNT1.getText())) == true) {
							ft1.setText("Flight number is already exsist");
			                return;
			            }
						if((FNT1.getText() !=null) && (ANT1.getText() !=null) &&(SORT1.getText() !=null) &&(DT1.getText() !=null) &&(CT1.getText() !=null)) {
						LN.AddFlightSorted(Integer.parseInt(FNT1.getText()), ANT1.getText(), SORT1.getText(), DT1.getText(), Integer.parseInt(CT1.getText()));
						PrintWriter f=new PrintWriter("Flightp");
						f.write(LN.printFlight());
						f.close();
				      	ft1.setText(" Correctly added :) ");
						...
						ft1.setText(" Enter all the information correctly :(");
						}

				});

				Image c = new Image("https://img.icons8.com/external-others-phat-plus/344/external-back-essential-blue-others-phat-plus.png");
			...
			b2.setOnAction(f23 -> {
				...
				Search.setOnAction(d699 -> {
					try {
						...
						ft1.setText(" Enter Flight number Correctly :(");
						}
				...
				root5.add(Update, 2, 6);

				p3.setEditable(false);
				Update.setOnAction(d93 -> {
					p0.setEditable(true);
					try {
						if(p0.getText() !=null && p11.getText() !=null &&p22.getText() !=null &&p44.getText() !=null &&p3.getText() !=null) {
							LN.EditFlight(Integer.parseInt(p0.getText()), p11.getText(), p22.getText(), p44.getText(), Integer.parseInt(p3.getText()));
							PrintWriter f=new PrintWriter("Flightp");
							f.write(LN.printFlight());
							f.close();
						ft1.setText(" Correctly Update :) ");
				...
				Scene scene5 = new Scene(root5, 550, 500);
				s5.setScene(scene5);
		...
		x4.setOnAction(rr4 -> {
			...
			add1.setOnAction(d77800 -> {
				try {
					if(FlightNumberTex1.getText() !=null && TicketNumberTex1.getText() !=null &&FullNameText1.getText() !=null &&passportNumberTex1.getText() !=null &&NationalityTex1.getText() !=null &&birthDate1Tex1.getText() != null) {
					LN.AddPassengersSorted(Integer.parseInt(FlightNumberTex1.getText()),Integer.parseInt(TicketNumberTex1.getText()), FullNameText1.getText(), passportNumberTex1.getText(), NationalityTex1.getText(), birthDate1Tex1.getText());
					PrintWriter f=new PrintWriter("passengerp");
					f.write(LN.printpassenger());
					f.close();
					ft1.setText(" Correctly added :) ");
			...
			Image d = new Image("https://cdn-icons.flaticon.com/png/512/5105/premium/5105770.png?token=exp=1651253815~hmac=a4b02b072c395fd5a096592f1cd0fc57");
			ImageView dd = new ImageView();
			dd.setImage(d);
			dd.setFitWidth(15);
			dd.setFitHeight(15);
			Button max = new Button("find max", dd);
			max.setPrefSize(120, 50);
			root2.add(max, 1, 7);
			
			TicketNumberTex1.setEditable(false);
			max.setOnAction(m23->{
				try {
					
					TicketNumberTex1.setText(String.valueOf(LN.MaxTikat(Integer.parseInt(FlightNumberTex1.getText()))));
				}catch(Exception d12){
					ft1.setText(" Enter flight number just :(");
		...
		x5.setOnAction(k6791 -> {
			...
			D2.setOnAction(d678971 -> {
				try {
					if(FlightNumberTex2.getText() !=null && FullName2Tex2.getText() !=null ) {
					LN.deletPassenger(Integer.parseInt(FlightNumberTex2.getText()),FullName2Tex2.getText());
					PrintWriter f=new PrintWriter("passengerp");
					f.write(LN.printpassenger());
					f.close();
					ft1.setText(" Correctly delete :) ");
			...
			Image b1 = new Image("https://img.icons8.com/external-others-phat-plus/344/external-back-essential-blue-others-phat-plus.png");
		...
		x7.setOnAction(e4 -> {
			...
			TextArea textArea2 = new TextArea();
			textArea2.setPromptText(" information for a passengers");
			Image n1 = new Image(
					"https://img.icons8.com/external-others-phat-plus/344/external-back-essential-blue-others-phat-plus.png");
			...
			intreted1.setOnAction(m -> {
				try {
					if(textField2.getText() != null ) {
						...
						textArea2.setText("enter full name!");

					}
					}catch(Exception b) {

					
					textArea2.setText("Enter full name correctly :(");
			...
			Scene sceneRent2 = new Scene(rentpane2, 800, 500);
		...
		x6.setOnAction(w982 -> {
			...
			intreted1.setOnAction(f99er -> {
				...
				textArea2.setText(String.valueOf(x));
						...
						textArea2.setText(" Enter the flight number of the number type !! ");

					}catch(Exception c) {
					textArea2.setText(" Enter the all information !");
				}
			});
